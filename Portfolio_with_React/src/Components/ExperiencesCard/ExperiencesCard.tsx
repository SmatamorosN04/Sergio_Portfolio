...
return(
    <section className='mt-10'>
        ...
        <article className='w-full mt-5  border  border-gray-800 p-4 rounded-lg bg-white h-40'>
            <div className='grid grid-cols-5 grid-rows-2 h-20'>
                <h1 className='text-2xl col-start-1 col-end-3
                font-bold text-black'>{name}</h1>
                <p className='text-lg col-start-3 col-end-3 hidden
                font-light text-gray-500 text-start align-middle'>{mail}</p>
                <p className='text-lg font-light col-start-4 col-end-6
                text-gray-500 text-center'>{time}</p>
