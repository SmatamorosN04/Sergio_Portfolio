    ...
    return (
        <div className="relative bg-slate-950 selection:bg-cyan-500/30 selection:text-cyan-200">
            ...
            <main className="relative z-10 max-w-5xl mx-auto px-6 sm:px-10 lg:px-12">
                ...
                <section id="experiencia" className="py-24 border-t border-slate-900">
                    <div className="mb-12">
                        <h2 className="text-3xl font-bolf text-white flex items-center gap-4">
                ...
                <section id="proyectos" className="py-24 border-t border-slate-900">
                    <div className="mb-12">
                        <h2 className="text-3xl font-bold text-white flex items-center gap-4">
                            <span className="text-xyan-500 font-mono text-xl">02.</span>
                ...
                <section id="skills" className="py-24 border-t border-slate-900">
                    <div className="mb-12">
                        <h2 className="text-3xl font-bold text-white flex items-center gap-4">
                ...
                <section id="contacto" className="py-24 border-t border-slate-900">
                    <Contact/>
                </section>
